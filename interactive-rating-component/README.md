...
Please find the demo of the application that is build below:

![App demo](./public/assets/frontend-mentor-1.gif)
...
- [W3 resource](https://www.w3schools.com/howto/howto_js_active_element.asp)
